  ...
  return (
    <div className='w-full h-full flex flex-row'>
        <div className="w-[38%] h-full overflow-hidden">
            <Image src={sampleEvents[0].Image} width={500} height={500} alt="Event" className='w-full h-full object-cover object-center' />
        </div>
        ...
        <div className="w-[55%] h-full flex flex-col items-start gap-4 px-8 py-5">
            ...
            <div className="w-full h-[5%] flex flex-row-reverse">
              <Button variant={"default"} className='font-semibold px-6 py-4 text-[16px] bg-primary hover:bg-primary/70'>Book</Button>
            </div>
        </div>
    </div>
  )
