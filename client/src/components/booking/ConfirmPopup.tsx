  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-white rounded-lg shadow-lg w-[400px] p-6">
        <div className="w-full h-[150px] bg-gray-200 rounded-t-lg overflow-hidden">
          <img
        ...
        <div className="p-4">
          <h2 className="text-xl font-bold text-center text-[#1D1D1D] mb-2">
            {eventName}
          </h2>
          ...
          <div className="flex justify-between items-center mb-4">
            <p className="text-sm text-gray-600">
              Ticket price:{" "}
              <span className="text-[#02471F] font-bold">${ticketPrice} each</span>
            </p>
            <p className="text-sm text-gray-600">
