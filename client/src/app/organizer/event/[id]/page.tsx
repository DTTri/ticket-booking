...
import { CreateEventDTO, RescheduleEventDTO, SectionPricingDTO, UpdateEventDTO } from "@/models/DTO/EventDTO";
...
export default function EventPage() {
  ...
  const { loadVenue, isLoadingDetails: isLoadingVenueDetails, venue } = useVenueDetails();
  const { venues, loadVenues, isLoadingList: isLoadingVenuesList } = useVenueList();
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  ...
                  {status === "Postponed" &&
                    "Your event has been postponed. You can reschedule it."}
                ...
                {status &&
                  statusOptions[status as keyof typeof statusOptions]?.map(option => (
                    <Button
                      key={option}
                      onClick={() =>
                        handleStatusAction(option as EventStatus)
                      }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border border-gray-300 rounded-md overflow-hidden">
                ...
                <div className="max-h-64 overflow-y-auto">
                  {!eventId && (selectedVenue.sections.map((section, index) => (
                  ...
                  {eventId && !prices.length && (prices.map((item, index) => (
                    <div key={index} className="grid grid-cols-2 p-3 border-t border-gray-200">
